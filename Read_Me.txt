...
star clusters subject to time-dependent realistic tidal fields, 
...
For each galactic model we includ a visualisation of the galaxy, 
both face-on and edge-on, and present the orbits of several clusters following 
different galactic trajectories. 

For each orbit we created a directory in which we included the following files:
...
Plot_parameters.m MATLAB script.
